...
# This file was *autogenerated* from the file bin-terSIDH--hybrid.sage
from sage.all_cmdline import *   # import sage library

_sage_const_128 = Integer(128); _sage_const_1 = Integer(1); _sage_const_192 = Integer(192); _sage_const_256 = Integer(256); _sage_const_203 = Integer(203); _sage_const_296 = Integer(296); _sage_const_387 = Integer(387); _sage_const_156 = Integer(156); _sage_const_226 = Integer(226); _sage_const_293 = Integer(293); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1000 = Integer(1000); _sage_const_6 = Integer(6); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10)
import random
import time
...
params_binSIDH = [_sage_const_203 , _sage_const_296 , _sage_const_387 ]
params_terSIDH = [_sage_const_156 , _sage_const_226 , _sage_const_293 ]
...
def compute_kernel_scalars(s):
    ...
    for i, p in enumerate(Primes()[_sage_const_1 :t+_sage_const_1 ]):
        if s[i] == _sage_const_1 :
            B1 *= p
            order0 *= p
        elif s[i] == _sage_const_2 :
            B0 *= p
            order1 *= p
        else:
            B0 *= p
...
##### Setup ############################
A = _sage_const_2 **(_sage_const_2 *lam)
B = prod(Primes()[_sage_const_1 :t+_sage_const_1 ])
...
if A//_sage_const_2  * PA == E0(_sage_const_0 , _sage_const_0 ):
    PA = PA + QA
elif A//_sage_const_2  * (PA+QA) == E0(_sage_const_0 , _sage_const_0 ):
    QA = PA + QA 
...
assert A//_sage_const_2  * PA != E0(_sage_const_0 , _sage_const_0 ) and A//_sage_const_2  * (PA+QA) != E0(_sage_const_0 , _sage_const_0 )
...
def keygenA():
    skA = random.randint(_sage_const_0 , A - _sage_const_1 )
